...
def speak_gesture(gesture):
    ...
    if gesture != last_spoken_gesture or (time.time() - last_spoken_time) > 2:
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if Index_Pip_y < Thumb_Tip_y and Ring_Pip_y < Thumb_Tip_y and Pinky_Pip_y < Thumb_Tip_y:
                    if Index_Tip_y < Index_Pip_y and Ring_Tip_y < Ring_Pip_y and Pinky_Tip_y < Middle_Tip_y:
                        ...
                        gesture1 = 'Gesture : 8'
                        spoken_gesture = "Eight"

                if Index_Pip_y < Thumb_Tip_y and Middle_Pip_y < Thumb_Tip_y and Pinky_Pip_y < Thumb_Tip_y:
                ...
                if spoken_gesture:
                    threading.Thread(target=speak_gesture, args=(spoken_gesture,)).start()
